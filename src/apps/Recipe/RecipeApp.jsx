...
import { addRecipe as addRecipeAPI } from './utils/api'

function RecipeApp() {
  const [recipes, setRecipes] = useState([
    { id: 1, title: 'Pasta', ingredients: 'Pasta, Tomato sauce, Cheese', instructions: 'Boil pasta. Add sauce. Sprinkle cheese.' }
  ])
